...
// Set up the official Google Gen AI runtime using your secure environment variable
...
app.post('/api/chat', async (req, res) => {
    ...
    try {
        // Utilizing the ultra-fast flash structure for lightning-speed responses
        ...
        console.error("OmniPad Generation Error Pipeline:", error);

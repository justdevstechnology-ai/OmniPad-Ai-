...
// =======================================================
// 🔊 ACCESSIBILITY AUDIO MODULES (ROBUST GITHUB COMPATIBLE)
// =======================================================
window.speakMessage = function(msgId, button) {
    if ('speechSynthesis' in window) {
        ...
        // 🛠️ FIXED: Scrape textContent explicitly from text wrappers while omitting UI code action titles
        let textToSpeak = "";
        ...
        // Android/Redmi mobile performance optimizations
        utterance.rate = 1.0;
        utterance.pitch = 1.0;
